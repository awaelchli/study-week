...
\section{Theory}
	...
	\subsection{A Simple Mosaicking Algorithm}
		...
		As explained later in the assignments, you will use nearest neighbor search and implement the average distance for your first Mosaicking algorithm.

\section{Assignments}

	\subsection{Average Color Distance}
